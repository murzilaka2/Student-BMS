<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit_user.aspx.cs" Inherits="BMS.panel.assets.edit_user" EnableEventValidation="false"%>
...
<html>
     <head>      
        <title>BMS | Редактирование Пользователя</title>       
        <meta content="width=device-width, initial-scale=1" name="viewport"/>
        <meta charset="UTF-8">
        <meta name="description" content="BMS - Редактирование Пользователя." />        
        <!-- Styles -->
            ...
            <div class="page-inner">
                <div class="page-breadcrumb">
                    <ol class="breadcrumb container">
                        <li><a href="users.aspx">Персонал</a></li>
                            ...
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                            <label for="input-Default" class="col-sm-2 control-label">Статус</label>
                                            <div class="col-sm-10">
                                                <asp:RadioButton runat="server" ID="AdminRadio" Text="Администратор" GroupName="Status" Enabled="false"/>
                                                <asp:RadioButton runat="server" ID="UserRadio" Text="Пользователь" GroupName="Status" Enabled="false"/>
                                                <br /><br />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="input-Default" class="col-sm-2 control-label">Логин</label>
                                            <div class="col-sm-10">
                                                <asp:TextBox runat="server" CssClass="form-control" ID="Login" required></asp:TextBox>
                                                <br />
                                            </div>
                                        </div>                              
                                    <div class="form-group">
                                            <label for="input-help-block" class="col-sm-2 control-label">Фио</label>
                                            <div class="col-sm-10">
                                                <asp:TextBox runat="server" CssClass="form-control" ID="Fio" required></asp:TextBox>
                                                <br />                                    
                                            </div>
                                        </div>
                                     <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <asp:TextBox runat="server" CssClass="form-control" ID="Email" TextMode="Email" required></asp:TextBox>
                                                <br />                                    
                                            </div>
                                        </div>
                                     <div class="form-group">
                                            <label for="input-help-block" class="col-sm-2 control-label">Телефон</label>
                                            <div class="col-sm-10">
                                                <asp:TextBox runat="server" CssClass="form-control" ID="Phone" required></asp:TextBox>
                                                <br />                                    
                                            </div>
                                        </div>
                                     <div class="form-group">
                                            <label for="input-help-block" class="col-sm-2 control-label">Дата принятия</label>
                                            <div class="col-sm-10">
                                                <asp:TextBox runat="server" CssClass="form-control" ID="StartDate" required></asp:TextBox>
                                                <br />                                    
                                            </div>
                                        </div>
                                     <div class="form-group">
                                            <label for="input-help-block" class="col-sm-2 control-label">Зарплата</label>
                                            <div class="col-sm-10">
                                                <asp:TextBox runat="server" CssClass="form-control" ID="Salary" TextMode="Number" required></asp:TextBox>
                                                <br />                                    
                                            </div>
                                        </div>
                                     <div class="form-group">
                                            <label for="input-help-block" class="col-sm-2 control-label">Должность</label>
                                            <div class="col-sm-10">
                                                <asp:TextBox runat="server" CssClass="form-control" ID="Position" required></asp:TextBox>
                                                <br />                                    
                                            </div>
                                        </div>
                                    <div class="form-group">
                                            <label for="input-help-block" class="col-sm-2 control-label">Аватар</label>
                                            <div class="col-sm-10">
                                                <asp:TextBox runat="server" CssClass="form-control" ID="ImageUrl"></asp:TextBox>
                                                <br />                                    
                                            </div>
                                        </div>
                                    <div class="form-group" style="text-align: -webkit-center;"><br />
                                    <asp:Button runat="server" CssClass="btn btn-default btn-lg" ID="Edit_User" Text="Редактировать" OnClick="Edit_User_Click"/>                                   
                                    </div>
                                    <div class="form-group" style="text-align: -webkit-center;"><br />
                                 ...
                                 <div class="panel-body">
                                     <h3 style="text-align: -webkit-center;  margin-bottom: 30px;">Редактирование Пароля</h3>
                                     <div class="form-group">
                                            <label for="input-help-block" class="col-sm-2 control-label">Старый Пароль</label>
                                            <div class="col-sm-10">
                                     ...
                                     <div class="form-group">
                                            <label for="input-help-block" class="col-sm-2 control-label">Новый Пароль</label>
                                            <div class="col-sm-10">
                                      ...
                                      <div class="form-group" style="text-align: -webkit-center;"><br />
                                    <asp:Button runat="server" CssClass="btn btn-default btn-lg" ID="PasswordReset" Text="Изменить" OnClick="PasswordReset_Click"/>                                   
                                    </div>
                                      <div class="form-group" style="text-align: -webkit-center;"><br />
                                    <label runat="server" id="password_output"></label>                                  
                                    </div>
                                  </div>
                            </div>
                        </div>
