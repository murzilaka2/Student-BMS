<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit_service.aspx.cs" Inherits="BMS.panel.edit_service" %>
...
<html>
     <head>      
        <title>BMS | Редактирование Услуги</title>       
        <meta content="width=device-width, initial-scale=1" name="viewport"/>
        <meta charset="UTF-8">
        <meta name="description" content="BMS - Редактирование Услуги." />
        <!-- Styles -->
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    ...
                                    <asp:Button runat="server" CssClass="btn btn-default btn-lg" ID="Edit_Service" Text="Редактировать" OnClick="Edit_Service_Click"/>                                   
                                    </div>
                                    <div class="form-group" style="text-align: -webkit-center;"><br />
