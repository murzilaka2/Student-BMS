<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="message_view.aspx.cs" Inherits="BMS.panel.message_view" %>
...
<html>
    <head>
        <title>BMS | Сообщение</title>       
        <meta content="width=device-width, initial-scale=1" name="viewport"/>
        <meta charset="UTF-8">
        <meta name="description" content="BMS - Сообщение." />
        <!-- Styles -->
                                ...
                                <div class="col-md-4">
                                    <div class="compose-options">
                                        <div class="pull-right">
                                            <a href="inbox.html" class="btn btn-default"><i class="fa fa-file-text-o m-r-xs"></i>Черновик</a>
                                            <a href="#" class="btn btn-danger" runat="server" ID="DeleteMessage2"><i class="fa fa-trash m-r-xs"></i>Удалить</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="panel panel-white">
                                <div class="panel-body mailbox-content">
                                    <div class="message-header">
                                        <h3 runat="server" ID="MessageHeader"></h3>
                                        <p class="message-date" runat="server" ID="MessageDate"></p>
                                    </div>
                                    <div class="message-sender">
                                        <a href="#" runat="server" ID="UserProfile"><img src="assets/images/avatar2.png" alt="Аватар" runat="server" ID="MessageAvatar"></a>
                                        <p><span runat="server" ID="MesssageFio"></span> <span runat="server" ID="MessageEmail">&lt;&gt;</span></p>
                                        <p class="message-date" runat="server" ID="MessageTime" style="float:right"></p>
                                    </div>
                                    ...
                                    <div class="message-options pull-right">
                                        <a href="#" class="btn btn-default" runat="server" ID="ReSent"><i class="fa fa-reply m-r-xs"></i>Ответить</a> 
                                        <a href="#" class="btn btn-default" runat="server" ID="DeleteMessage"><i class="fa fa-trash m-r-xs"></i>Удалить</a> 
                                    </div>
                                </div>
                            </div>
                        </div>
