<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add_product_category.aspx.cs" Inherits="BMS.panel.add_product_category" %>
...
<html>
     <head>      
        <title>BMS | Новая Категория Товаров</title>       
        <meta content="width=device-width, initial-scale=1" name="viewport"/>
        <meta charset="UTF-8">
        <meta name="description" content="BMS - Новая Категория Товаров." />        
        <!-- Styles -->
            ...
            <div class="page-inner">
                <div class="page-breadcrumb">
                    <ol class="breadcrumb container">
                        ...
                        <li class="active">Новая Категория Товаров</li>
                    </ol>
                </div>
                <div class="page-title">
                    <div class="container">
                        <h3>Новая Категория Товаров</h3>
                    </div>
                </div>
                    ...
                    <div class="row">                        
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                ...
                                <a href="add_product.aspx">Добавить новый товар <i class="fa fa-edit"></i></a>
                                </div>
                                <div class="panel-body">                                   
                                    ...
                                    <asp:Button runat="server" CssClass="btn btn-default btn-lg" ID="Add_Product_Category" Text="Добавить" OnClick="Add_Product_Category_Click"/>                                   
                                    </div>
                                    <div class="form-group" style="text-align: -webkit-center;"><br />
