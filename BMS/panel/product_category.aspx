<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="product_category.aspx.cs" Inherits="BMS.panel.product_category" %>
...
<html>
    <head>      
        <title>BMS | Категории Товаров</title>       
        <meta content="width=device-width, initial-scale=1" name="viewport"/>
        <meta charset="UTF-8">
        <meta name="description" content="BMS - Категории Товаров." />     
        <!-- Styles -->
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-body">
                                  <p>При удалении категории, все товары привязанные к ней, удаляются автоматически.</p> 
                                   <div class="table-responsive">  
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <tbody>
                                            <asp:PlaceHolder runat="server" ID="Products_Category_Placeholder"></asp:PlaceHolder>
                                        </tbody>
                                       </table>                                                                                             
                                    </div>                                  
                                </div>
