<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="send_messages.aspx.cs" Inherits="BMS.panel.send_messages" %>
...
<html>
    <head>
        <title>BMS | Отправленные</title>       
        <meta content="width=device-width, initial-scale=1" name="viewport"/>
        <meta charset="UTF-8">
        <meta name="description" content="BMS - Отправленные." />
        <!-- Styles -->
                    ...
                    <div class="row m-t-md">
                        ...
                        <div class="col-md-2">
                            <ul class="list-unstyled mailbox-nav">
                                ...
                                <li class="active"><a href="send_messages.aspx"><i class="fa fa-sign-out"></i>Отправленные</a></li>
                                ...
                                <thead>
                                    <tr>
                                        <th class="text-right" colspan="5">
                                            ...
                                            <a class="btn btn-default m-r-sm" data-toggle="tooltip" data-placement="top" title="Refresh" href="send_messages.aspx"><i class="fa fa-refresh"></i></a>
