<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit_service_category.aspx.cs" Inherits="BMS.panel.edit_service_category" %>
...
<html>
     <head>      
        <title>BMS | Редактирование Категории Услуг</title>       
        <meta content="width=device-width, initial-scale=1" name="viewport"/>
        <meta charset="UTF-8">
        <meta name="description" content="BMS - Редактирование Категории Услуг." />     
        <!-- Styles -->
            ...
            <div class="page-inner">
                <div class="page-breadcrumb">
                    <ol class="breadcrumb container">
                        <li><a href="service_category.aspx">Категория Услуг</a></li>
                        <li class="active">Редактирование Категории Услуг</li>
                    </ol>
                </div>
                <div class="page-title">
                    <div class="container">
                        <h3>Редактирование Категории Услуг</h3>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">                                   
                                    ...
                                    <asp:Button runat="server" CssClass="btn btn-default btn-lg" ID="Edit_Category_Service" Text="Редактировать" OnClick="Edit_Category_Service_Click1"/>                                   
                                    </div>
                                    <div class="form-group" style="text-align: -webkit-center;"><br />
