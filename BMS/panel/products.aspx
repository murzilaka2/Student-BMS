<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="products.aspx.cs" Inherits="BMS.panel.assets.products" %>
...
<html>
    <head>      
        <title>BMS | Товары</title>       
        <meta content="width=device-width, initial-scale=1" name="viewport"/>
        <meta charset="UTF-8">
        <meta name="description" content="BMS - Товары." />        
        <!-- Styles -->
        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                ...
                <div id="main-wrapper" class="container">
                   ...
                   <button type="button" class="btn btn-default btn-addon m-b-sm" id="new_product" runat="server" onserverclick="new_product_ServerClick"><i class="fa fa-plus"></i>Добавить товар</button>
                    <div class="row">
                        <div class="col-md-12">
                                ...
                                <div class="panel-body">
                                   <div class="table-responsive">
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <tbody>
                                            <asp:PlaceHolder runat="server" ID="Products_Placeholder"></asp:PlaceHolder>
                                        </tbody>
                                       </table>                                                                                                
                                    </div>                                  
                                </div>
