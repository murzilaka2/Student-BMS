<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="orders.aspx.cs" Inherits="BMS.panel.orders" %>
...
<html>
    <head>
        ...
        <!-- Title -->
        <title>BMS | Заказы</title>        
        <meta content="width=device-width, initial-scale=1" name="viewport"/>
        <meta charset="UTF-8">
        <meta name="description" content="BMS - Заказы." />
        <!-- Styles -->
        ...
        <main class="page-content content-wrap">          
            ...
            <div class="page-inner">
                ...
                <div class="page-title">
                    <div class="container">
                        <h3>Товары / <a href="orders_service.aspx">Услуги</a></h3>
                    </div>
                </div><br />
                <div class="container">
                    <div class="row">
                        <asp:PlaceHolder runat="server" ID="ProductsPlace"></asp:PlaceHolder>
                    </div>
                </div>
                            ...
                            <div class="panel">
                                <div class="panel-body" >
                                    ...
                                    <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    <asp:PlaceHolder runat="server" ID="ProductsPlaceholder"></asp:PlaceHolder>
                                                </tbody>
                                            </table>
                                    </div>
                                        <hr>
