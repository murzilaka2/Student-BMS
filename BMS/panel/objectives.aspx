<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="objectives.aspx.cs" Inherits="BMS.panel.objectives" %>
...
<html>
    <head>
        ...
        <!-- Title -->
        <title>BMS | Цели</title>        
        <meta content="width=device-width, initial-scale=1" name="viewport"/>
        <meta charset="UTF-8">
        <meta name="description" content="BMS - Цели." />
            ...
            <div class="page-sidebar sidebar horizontal-bar">
                <div class="page-sidebar-inner">
                    <ul class="menu accordion-menu">
                        ...
                        <li class="active"><a href="objectives.aspx" class="active"><span class="menu-icon icon-bar-chart"></span><p>Цели</p><span class="arrow"></span></a></li>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white todo">
                                <div class="panel-body">
                                        <asp:TextBox runat="server" CssClass="form-control" placeholder="Новая цель..." ID="NewObjective"></asp:TextBox>                                   
                                        <asp:Button runat="server" ID="GetValue" OnClick="GetValue_Click" CssClass="hidden"/>
                                    <ul class="nav nav-pills todo-nav">
                                        <li role="presentation" class="active all-task"><a href="#">Все</a></li>
                                        <li role="presentation" class="active-task"><a href="#">Активные</a></li>
                                        <li role="presentation" class="completed-task"><a href="#">Выполненные</a></li>
                                    </ul>
                                    <div class="todo-list">
                                        <asp:PlaceHolder runat="server" ID="Todo"></asp:PlaceHolder>                                                                                                                                                
                                    </div>
                                </div>
                            </div>
                        </div>
