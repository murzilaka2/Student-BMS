<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add_product.aspx.cs" Inherits="BMS.panel.services.add_product" %>
...
<html>
     <head>      
        <title>BMS | Новый Товар</title>       
        <meta content="width=device-width, initial-scale=1" name="viewport"/>
        <meta charset="UTF-8">
        <meta name="description" content="BMS - Новый Товар." />       
        <!-- Styles -->
                    ...
                    <div class="row">                        
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-heading clearfix" style="text-align: -webkit-center;">
                                <a href="add_product_category.aspx">Добавить новую категорию <i class="fa fa-edit"></i></a>
                                </div>
                                <div class="panel-body">
                                    <div class="form-group">
                                            <label for="input-Default" class="col-sm-2 control-label">Категория</label>
                                            <div class="col-sm-10">
                                            <asp:DropDownList runat="server" ID="Category" CssClass="js-states form-control"></asp:DropDownList>                                            
                                            <br />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="input-help-block" class="col-sm-2 control-label">Количество</label>
                                            <div class="col-sm-10">
                                                <asp:TextBox runat="server" CssClass="form-control" ID="Count" TextMode="Number" required></asp:TextBox>
                                                <br />
                                            </div>
                                        </div>
                                    <div class="form-group">
                                            <label for="input-help-block" class="col-sm-2 control-label">Закупочная цена</label>
                                            <div class="col-sm-10">
                                                <asp:TextBox runat="server" CssClass="form-control" ID="PurchasePrice" TextMode="Number" required></asp:TextBox>
                                                <br />                                    
                                            </div>
                                        </div>
                                     <div class="form-group">
                                            <label for="input-help-block" class="col-sm-2 control-label">Розничная цена</label>
                                            <div class="col-sm-10">
                                                <asp:TextBox runat="server" CssClass="form-control" ID="CostOfSales" TextMode="Number" required></asp:TextBox>
                                                <br />                                    
                                            </div>
                                        </div>
                                     <div class="form-group">
                                    ...
                                    <div class="form-group">
                                            <label for="input-help-block" class="col-sm-2 control-label">Изображение</label>
                                            <div class="col-sm-10">
                                                <asp:TextBox runat="server" CssClass="form-control" ID="Image"></asp:TextBox>
                                                <br />                                    
                                            </div>
                                        </div>                                  
                                    <div class="form-group" style="text-align: -webkit-center;"><br />
                                    <asp:Button runat="server" CssClass="btn btn-default btn-lg" ID="Add_Product" Text="Добавить" OnClick="Add_Product_Click"/>                                   
                                    </div>
                                    <div class="form-group" style="text-align: -webkit-center;"><br />
