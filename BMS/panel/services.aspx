<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="services.aspx.cs" Inherits="BMS.panel.assets.services" %>
        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                ...
                <div id="main-wrapper" class="container">
                   ...
                   <button type="button" class="btn btn-default btn-addon m-b-sm" id="new_service" runat="server" onserverclick="new_service_ServerClick"><i class="fa fa-plus"></i>Добавить услугу</button>
                    <div class="row">
                        <div class="col-md-12">
                                ...
                                <div class="panel-body">
                                   <div class="table-responsive">
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <tbody>
                                            <asp:PlaceHolder runat="server" ID="Service_Placeholder"></asp:PlaceHolder>
                                        </tbody>
                                       </table>                                                                                                
                                    </div>                                  
                                </div>
