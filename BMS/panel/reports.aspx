<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reports.aspx.cs" Inherits="BMS.panel.reports" %>
...
<html>
    <head>        
        <title>BMS | Отчеты</title>      
        <meta content="width=device-width, initial-scale=1" name="viewport"/>
        <meta charset="UTF-8">
        <meta name="description" content="BMS - Отчеты." />        
        <!-- Styles -->
            ...
            <div class="page-sidebar sidebar horizontal-bar">
                <div class="page-sidebar-inner">
                    <ul class="menu accordion-menu">
                        ...
                        <li class="active"><a href="reports.aspx"><span class="menu-icon icon-briefcase"></span><p>Отчеты</p><span class="arrow"></span></a></li>
                                ...
                                <div class="panel-body">
                                   <div class="table-responsive">
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <tbody>
                                            <asp:PlaceHolder runat="server" ID="ReportsPlaceholder"></asp:PlaceHolder>                                      
                                        </tbody>
                                       </table>  
                                    </div>
                                </div>
                            ...
                            <div class="panel panel-white">
                                <div class="panel-body">
                                   <div class="table-responsive">
                                       ...
                                       <p>Отчет за указанную дату:
                                           <asp:TextBox runat="server" ID="Date" TextMode="DateTime"></asp:TextBox>
                                           <asp:Button runat="server" ID="GetReport" Text="Сформировать" OnClick="GetReport_Click"/>
                                       </p>
                                           </div>
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        <thead>
                                        ...
                                        <tbody>
                                            <asp:PlaceHolder runat="server" ID="OwnReportsPlaceholder"></asp:PlaceHolder>                                      
                                        </tbody>
                                       </table>  
                                    </div>
                                </div>
                            ...
                            <div class="panel panel-white">
                                <div class="panel-body">
                                   <div class="table-responsive">
                                       <div style="text-align:center;">
                                       <p>Отчет за указанную дату:
                                           <asp:TextBox runat="server" ID="DateService" TextMode="DateTime"></asp:TextBox>
                                           <asp:Button runat="server" ID="GerReportService" Text="Сформировать" OnClick="GerReportService_Click"/>
                                       </p>
                                           </div>
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        <thead>
                                        ...
                                        <tbody>
                                            <asp:PlaceHolder runat="server" ID="OwnSericeReportsPlaceholder"></asp:PlaceHolder>                                      
                                        </tbody>
                                       </table>  
                                    </div>
                                </div>
