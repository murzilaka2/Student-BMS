<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="messages.aspx.cs" Inherits="BMS.panel.messages" %>
...
<html>
    <head>
        <title>BMS | Сообщения</title>       
        <meta content="width=device-width, initial-scale=1" name="viewport"/>
        <meta charset="UTF-8">
        <meta name="description" content="BMS - Сообщения." />
                    ...
                    <div class="row m-t-md">
                        ...
                        <div class="col-md-2">
                            <ul class="list-unstyled mailbox-nav">
                                <li class="active"><a href="messages.aspx"><i class="fa fa-inbox"></i>Входящие <span class="badge badge-success pull-right" runat="server" ID="MessagesCount"></span></a></li>
