<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add_service.aspx.cs" Inherits="BMS.panel.add_service" %>
...
<html>
     <head>      
        <title>BMS | Новая Услуга</title>       
        <meta content="width=device-width, initial-scale=1" name="viewport"/>
        <meta charset="UTF-8">
        <meta name="description" content="BMS - Новая Услуга." />       
        <!-- Styles -->
                    ...
                    <div class="row">                        
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                ...
                                <a href="add_service_category.aspx">Добавить новую категорию <i class="fa fa-edit"></i></a>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <asp:TextBox runat="server" CssClass="form-control" ID="Image" required></asp:TextBox>
                                                <br />                                    
                                            </div>
                                        </div>                                    
                                    <div class="form-group" style="text-align: -webkit-center;"><br />
                                    <asp:Button runat="server" CssClass="btn btn-default btn-lg" ID="Add_Service" Text="Добавить" OnClick="Add_Service_Click"/>                                   
                                    </div>
                                    <div class="form-group" style="text-align: -webkit-center;"><br />
