<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="new_user.aspx.cs" Inherits="BMS.panel.new_user" %>
...
<html>
     <head>      
        <title>BMS | Новый Пользователь</title>       
        <meta content="width=device-width, initial-scale=1" name="viewport"/>
        <meta charset="UTF-8">
        <meta name="description" content="BMS - Новый Пользователь." />      
        <!-- Styles -->
                            ...
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <asp:RadioButton runat="server" ID="Admin" Text="Администратор" GroupName="Status"/>
                                                <asp:RadioButton runat="server" ID="User" Text="Пользователь" GroupName="Status" Checked="true"/>
                                                <br /><br />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="input-help-block" class="col-sm-2 control-label">Пароль</label>
                                            <div class="col-sm-10">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <asp:TextBox runat="server" CssClass="form-control" ID="StartDate" TextMode="Date" required></asp:TextBox>
                                                <br />                                    
                                            </div>
                                        </div>
                                     <div class="form-group">
                                    ...
                                    <asp:Button runat="server" CssClass="btn btn-default btn-lg" ID="Add_User" Text="Добавить" OnClick="Add_User_Click"/>                                   
                                    </div>
                                    <div class="form-group" style="text-align: -webkit-center;"><br />
