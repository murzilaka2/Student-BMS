...
namespace BMS.panel.assets
{
    public partial class products : System.Web.UI.Page
    {
        ...
        private void LoadProducts()
        {
            ...
            foreach (var item in Database.ShowProducts(Request.Cookies["le"].Value.Substring(3)))
            {
                Products_Placeholder.Controls.Add(new LiteralControl("<tr><td>" + item.GetID() + "</td><td>" + item.GetName() + "</td><td>" + Database.GetProductCategoryName(item.GetCategoryID()) + "</td><td>" + item.GetCount() + "</td><td>" + item.GetPurchasePrice() + "</td><td>" + item.GetCostOfSales() + "</td><td>" + item.GetDescription() + "</td><td><a href=\"edit_product.aspx?edit_id=" + item.GetID() + "\"><i class=\"fa fa-pencil\"></i></a> &nbsp; &nbsp; <a href=\"delete_product.aspx?delete_id=" + item.GetID() + "\"><i class=\"fa fa-trash\"></i></a></td></tr>"));
            }
        }
        ...
        protected void new_product_ServerClick(object sender, EventArgs e)
        {
