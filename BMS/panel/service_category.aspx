<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="service_category.aspx.cs" Inherits="BMS.panel.assets.service_category" %>
...
<html>
    <head>      
        <title>BMS | Категории Услуг</title>       
        <meta content="width=device-width, initial-scale=1" name="viewport"/>
        <meta charset="UTF-8">
        <meta name="description" content="BMS - Категории Услуг." />
        <!-- Styles -->
            ...
            <div class="page-inner">
                <div class="page-breadcrumb">
                    <ol class="breadcrumb container">
                        ...
                        <li class="active">Категории Услуг</li>
                    </ol>
                </div>
                ...
                <div id="main-wrapper" class="container">
                   ...
                   <button type="button" class="btn btn-default btn-addon m-b-sm" id="new_caregory" runat="server" onserverclick="new_caregory_ServerClick"><i class="fa fa-plus"></i>Добавить категорию</button>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-body">
                                  <p>При удалении категории, все услуги привязанные к ней, удаляются автоматически.</p> 
                                   <div class="table-responsive">  
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <tbody>
                                            <asp:PlaceHolder runat="server" ID="Service_Category_Placeholder"></asp:PlaceHolder>
                                        </tbody>
                                       </table>                                                                                             
                                    </div>                                  
                                </div>
