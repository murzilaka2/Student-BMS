<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit_product.aspx.cs" Inherits="BMS.panel.edit_product" %>
...
<html>
     <head>      
        <title>BMS | Редактирование Товара</title>       
        <meta content="width=device-width, initial-scale=1" name="viewport"/>
        <meta charset="UTF-8">
        <meta name="description" content="BMS - Редактирование Товара." />       
        <!-- Styles -->
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    ...
                                    <asp:Button runat="server" CssClass="btn btn-default btn-lg" ID="Edit_Product" Text="Редактировать" OnClick="Edit_Product_Click"/>                                   
                                    </div>
                                    <div class="form-group" style="text-align: -webkit-center;"><br />
