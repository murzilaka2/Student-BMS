            ...
            <div class="rd-navbar-inner">
              ...
              <div class="rd-navbar-nav-wrap">
                ...
                <ul class="rd-navbar-nav">
                  ...
                  <li class="active"><a href="login.aspx">Аккаунт</a></li>
                  ...
                  <div class="row row-20">
                    <div class="col-sm-12">
                      <div class="form-wrap form-wrap-validation validation-with-outside-label">
                        <label class="form-label-outside" for="forms-sub-name">Логин</label>
                        <input class="form-input" type="text" required runat="server" ID="Login">
                      </div>
                    </div>
                    <div class="col-sm-12">
                      <div class="form-wrap form-wrap-validation validation-with-outside-label">
                        <label class="form-label-outside" for="forms-sub-password">Пароль</label>
                        <input class="form-input" type="password" required runat="server" ID="Password">
                      </div>
                    </div>
                    <label runat="server" ID="Error" visible="false"></label>
                    <div class="col-sm-6">
                     <asp:Button runat="server" CssClass="btn btn-primary btn-xs round-xl btn-block form-el-offset-1" ID="Authorization_Button" Text="Вход" OnClick="Authorization_Button_Click"/>
                    </div>
                      <div class="col-sm-6">
                     <span><a href="forgot_password.aspx">Забыли пароль?</a></span>
                    </div>
